            ...
            <div class="row">
                ...
                <div class="col-lg-9" style="font-family: 'GmarketSansMedium';">
                    ...
                    <ul class="pagination pagination-template d-flex justify-content-center ">
                    	...
                    	<li class="page-item ">
                            <a class="page-link " onclick="movePage('${path}/res/subSearch?page=1');">
                            	<i class="fa fa-angle-left "></i><i class="fa fa-angle-left "></i>
                            </a>
                        </li>
                    	
                       	<li class="page-item ">
                            <a class="page-link " onclick="movePage('${path}/res/subSearch?page=${pageInfo.prevPage}');">
                        ...
                        <c:forEach begin="${pageInfo.startPage}" end="${pageInfo.endPage}" step="1" varStatus="status">
                        	...
                        	<c:if test="${pageInfo.currentPage != status.current}">
                        		<li class="page-item">
                        			<a class="page-link" onclick="movePage('${path}/res/subSearch?page=${status.current}');">
                        				<c:out value="${status.current}"/>	
                        			</a>
                        		</li>
                        	</c:if>
                        ...
                        <li class="page-item ">
                            <a class="page-link " onclick="movePage('${path}/res/subSearch?page=${pageInfo.nextPage}')">
                            	<i class="fa fa-angle-right "></i>
                            </a>
                        </li>
                        
                        <li class="page-item ">
                            <a class="page-link " onclick="movePage('${path}/res/subSearch?page=${pageInfo.maxPage}')">
